...
public class EmailJaCadastradoException extends RuntimeException {
	...
	//o super() serve para o construtor passar a mensagem para o construtor da classe pai (RuntimeException). O super(mensagem) repassa a 
	//mensagem para o construtor da RuntimeException — que é a classe pai. É ela que vai guardar essa mensagem internamente para o
	//GlobalExceptionHandler conseguir recuperar depois.
