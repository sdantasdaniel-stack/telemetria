...
public interface UsuarioRepository extends JpaRepository<Usuario, Long>{
	...
	// método para que o usuario consiga cadastrar um novo device pela API sem ter que mudar de lazy pra eager o fetch
	@Query("SELECT u FROM Usuario u LEFT JOIN FETCH u.empresas WHERE u.email = :email")
	Optional<Usuario> findByEmailComEmpresas(String email);
